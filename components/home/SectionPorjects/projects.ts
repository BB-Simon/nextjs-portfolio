...
const projects: Project[] = [
  {
    ...
    technologies: ['HTML', 'CSS', 'JavaScript', 'React', 'Redux', 'Redux Thunk', 'NodeJS', 'ExpressJS', 'MongoDB'],
  ...
  },
  {
    ...
    technologies: ['HTML', 'CSS', 'JavaScript', 'React', 'Redux', 'Redux Thunk', 'NodeJS', 'ExpressJS', 'Front-End Development' ],
    sourceLink: 'https://github.com/BB-Simon',
  ...
  },
  {
    ...
    description: 'Noii - is a micro-entrepreneurship community platform where entrepreneurs design, implement and share their initiatives.',
    popupDescription: 'Noii - is a micro-entrepreneurship community platform where entrepreneurs design, implement and share their initiatives. Each entrepreneur has his/her own dashboard wher he/she can draw, draft and publish his/her initiatives and interact with who like it or make it favorited or clone it or implemented it.',
    image: { src: '/assets/projects/noii.svg', title: 'Noii - Microinitiatives' },
    meta: ['Noii - Microinitiatives', 'Full Stack Dev', '2020'],
    technologies: ['HTML', 'CSS', 'JavaScript', 'React', 'Redux', 'Redux Thunk', 'MUI', 'Styled-Component', 'NodeJS', 'ExpressJS', 'MongoDB', 'API', 'RESTFul API', 'Front-End Development', 'Back-End Development'],
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'React', 'React-Redux', 'Redux-Toolkit', 'CSS Modules'],
  ...
  },
  {
    ...
    description: 'IPS programming summit 2023 is an AI-driven IPS international programming Summit that is the premiere global programming gathering conducted by and for the world’s programmers.',
    popupDescription: 'IPS programming summit 2023 is an AI-driven IPS international programming Summit that is the premiere global programming gathering conducted by and for the world’s programmers.',
    image: { src: '/assets/projects/ips.svg', title: 'IPS Programming Summit 2023' },
    meta: ['Microverse', 'Front End Dev', '2023'],
    technologies: ['HTML', 'CSS', 'javascript', 'JS DOM', 'ES6', 'Front End Development'],
