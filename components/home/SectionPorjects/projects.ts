...
const projects: Project[] = [
  {
    id: 0,
    name: "ReQuest",
    description: `ReQuest — An intelligent AI chat application that enables users to effortlessly discover products from nearby marketplaces through real-time conversations with a smart virtual assistant.`,
    popupDescription: `ReQuest — An intelligent AI chat application that enables users to effortlessly discover products from nearby marketplaces through real-time conversations with a smart virtual assistant.`,
    image: {
      src: "/assets/projects/request.png",
      title: "ReQuest",
    },
    meta: ["ReQuest", "Front End Developer", "2025"],
    technologies: [
      "JavaScript",
      "React",
      "Next.js",
    ...
    liveLink: "https://easely-new-landing.onrender.com/",
