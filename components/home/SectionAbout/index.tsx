          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm font-medium text-slate-800 dark:text-slate-400 my-6">
                Software developer with a background in building effective
                software solutions. 6+ years of industry experience, including
                mentoring 10+ junior developers to achieve concrete goals on a
                strict deadline.
              </p>
              <p className="text-sm font-medium text-slate-800 dark:text-slate-400 my-6">
                Grew up in a remote and collaborative environment. Strong skills
                in JavaScript, Typescript, React, Node, and Ruby on Rails.
                Passionate about learning cloud computing.
              </p>
              <Link
                  ...
                  <>
                    <Disclosure.Button
                      ...
                      className={`flex w-full justify-between py-6 ${
                        !open ? "border-b border-slate-500" : ""
                      }`}
                    >
                    ...
                    >
                      <Disclosure.Panel className="flex flex-wrap gap-3">
                        {languages.map(({ title, src }, i) => (
                          <div
                            key={i}
                            className="bg-slate-100 dark:bg-blackmain1 py-[10px] px-3 flex items-center rounded-lg shadow-sm"
                          >
